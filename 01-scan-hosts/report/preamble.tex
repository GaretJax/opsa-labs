...
\usepackage{longtable} % Support for tables spawning multiple pages, captions and footnotes
...
% Provide support for (indented) unnumbered chapter and section numbers
\usepackage{tocloft}
